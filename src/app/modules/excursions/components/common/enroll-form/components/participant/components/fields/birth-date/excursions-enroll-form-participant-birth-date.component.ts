...
@Component({
    selector: 'app-excursions-enroll-form-participant-birth-date',
    templateUrl: './excursions-enroll-form-participant-birth-date.component.html',
    styleUrls: ['./excursions-enroll-form-participant-birth-date.component.scss']
})
export class ExcursionsEnrollFormParticipantBirthDateComponent extends ExcursionsEnrollFormFieldBase {
